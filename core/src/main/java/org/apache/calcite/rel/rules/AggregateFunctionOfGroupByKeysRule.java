...
public class AggregateFunctionOfGroupByKeysRule
    extends RelRule<AggregateFunctionOfGroupByKeysRule.Config>
    implements TransformationRule {

  /** Creates an AggregateFunctionOfGroupByKeysRule. */
  protected AggregateFunctionOfGroupByKeysRule(Config config) {
    super(config);
  }
  ...
  public interface Config extends RelRule.Config {
    Config DEFAULT = ImmutableAggregateFunctionOfGroupByKeysRule.Config.of()
        .withRelBuilderFactory(RelFactories.LOGICAL_BUILDER)
        .withOperandFor(LogicalAggregate.class);

    @Override default AggregateFunctionOfGroupByKeysRule toRule() {
      return new AggregateFunctionOfGroupByKeysRule(this);
    }
